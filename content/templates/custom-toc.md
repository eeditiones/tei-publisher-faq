...
The following applies to TEI Publisher 7 (and all custom apps generated by it), which provides a clear structure for custom code like this. Publisher 7 uses the Open API standard to describe how server-side functionality can be called by clients.
...
If you are still on an older version of TEI Publisher, read the notes at the [end of this page](#older-versions-of-tei-publisher).
